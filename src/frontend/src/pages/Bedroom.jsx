...
const Bedroom = () => {
    ...
    return (
        <div className="container-fluid d-flex flex-column flex-shrink-0 page mb-5">
            ...
            {createSection('BEDROOM', 'Bed & Headboards', ['Bed'])}
            {createSection('BEDROOM', 'Dressers & Chests', ['Dresser'])}
            {createSection('BEDROOM', 'Table lighting & Nightstands', ['Nightstand', 'Table Lighting'])}
            {createSection('BEDROOM', 'Children Bed', ['Children Bed'])}
            {createSection('BEDROOM', 'Wall Decorations', ['Wall Decorations'])}
